...
namespace NapalmOS.Graphics
{
	public class Font
	{
		...
		// constructor
		public Font(int id, int w, int h, int sx, int sy, byte[] data)
		{
			this.ID = id;
			this.Width = w;
			this.Height = h;
		...
		public int GetStringWidth(string text) { return text.Length * (Width + SpacingX); }
		public int GetStringHeight(string text)
		{
			string[] lines = text.Split('\n');
			return (1 + lines.Length) * (Height + SpacingY);
		}
		...
		// fonts
		public static Font Font8x16 = new Font(Font8x16_ID, 8, 16, 0, 0, Font8x16_Data);
		public static Font Font8x8 = new Font(Font8x8_ID, 8, 8, 0, 0, Font8x8_Data);
		public static Font Font3x5 = new Font(Font3x5_ID, 3, 5, 1, 1, Font3x5_Data);

		// identifiers
		public const byte Font8x16_ID = 0;
		public const byte Font8x8_ID = 1;
		public const byte Font3x5_ID = 2;
		...
		{
			Font8x16.Data = Font8x16_Data;
			Font8x8.Data = Font8x8_Data;
			Font3x5.Data = Font3x5_Data;
		}
	}
}
